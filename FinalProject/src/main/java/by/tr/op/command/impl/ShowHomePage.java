...
public class ShowHomePage implements Command{
    ...
    private final static String POPULAR_POLLS="popularPolls";
    ...
    private final static String PAGE_REDIRECT="jsp/home.jsp";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            popularPolls=findPollService.getPopularPolls();
            request.setAttribute(POPULAR_POLLS, popularPolls);
        }
        catch(ServiceException e){
            request.setAttribute(REQUEST_ERROR_MESSAGE, ERROR_MESSAGE);
        }
