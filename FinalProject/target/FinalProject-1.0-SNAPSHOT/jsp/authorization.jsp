...
<html>
  <head>
    ...
    <fmt:message bundle="${loc}" key="local.authorization.page.title" var="title" />
    <fmt:message bundle="${loc}" key="local.authorization.page.login" var="login" />
    <fmt:message bundle="${loc}" key="local.authorization.page.password" var="password" />
    <fmt:message bundle="${loc}" key="local.authorization.page.submit" var="submit" />
