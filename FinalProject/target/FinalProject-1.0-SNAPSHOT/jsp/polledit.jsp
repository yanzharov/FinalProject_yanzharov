...
<html>
  <head>
    ...
    <fmt:message bundle="${loc}" key="local.poll.edit.title" var="title" />
    <fmt:message bundle="${loc}" key="local.poll.edit.theme" var="theme" />
    <fmt:message bundle="${loc}" key="local.poll.edit.state" var="state" />
    <fmt:message bundle="${loc}" key="local.poll.edit.image" var="image" />
    <fmt:message bundle="${loc}" key="local.poll.edit.submit" var="submit" />
  ...
  <body>
    <div class="container">
      <form class="form-signin" action="${pageContext.servletContext.contextPath}/Controller" method="post">
        ...
        <input name="commandName" type="hidden" value="EDIT_POLL"/>
        ...
        <p><select size="3"  name="state" class="select-control" required>
